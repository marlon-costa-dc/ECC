# Netmiko SSH Automation Examples

Examples referenced from [../SKILL.md](../SKILL.md).
...
Use documentation-range addresses in examples. Keep real inventory in an ignored local file or a secrets-managed system.
