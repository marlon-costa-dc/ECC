...
description: Use when reviewing Cisco IOS or IOS-XE snippets, building a change-window checklist, or explaining how to collect read-only evidence from a router or switch without making the incident worse.
origin: community
---
